...
namespace VirtualLibraryAPI.Library.Migrations
{
    ...
    [Migration("20230724135513_AddDepartmentsConnectionsWithItems")]
    partial class AddDepartmentsConnectionsWithItems
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("VirtualLibraryAPI.Domain.Entities.Department", b =>
                {
                    b.HasOne("VirtualLibraryAPI.Domain.Entities.User", "User")
                        .WithOne("Department")
                        .HasForeignKey("VirtualLibraryAPI.Domain.Entities.Department", "DepartmentID")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired()
